...
<section class="team-about-sec">
    <div class="sec-wp">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 team-about-content-wp order-2 order-lg-1 wow left-animation">
                ...
                <div class="row">
                    <div class="col-lg-10 mx-auto">
                        <div class="common-tabing-list team-tabing-list">
                            <button class="sec-btn tab-dropdown for-mob" type="button">Lynchburg Clinicians</button>
                                <ul>
                                    <?php
                                    $i = 0;
                ...
                <div class="row">
                    <div class="col-lg-10 mx-auto">
                            ...
                            <div class="team-member-content-box">
                                ...
                                <div class="row">
                                    ...
                                    while ($the_query->have_posts()) {
                                        ...
                                        <div class="col-lg-4 col-sm-6 wow fadeup-animation">
                        ...
                        if( isset($client_url) && !empty($client_url) ){ ?>
                            <div class="team-member-btn-wp wow fadeup-animation">
